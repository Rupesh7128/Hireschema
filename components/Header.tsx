...
export const Header: React.FC<HeaderProps> = ({ onNavigate }) => {
    ...
    return (
        <>
            <motion.header className="fixed top-0 left-0 right-0 z-50 flex items-center h-[80px] border-b border-white/15 bg-zinc-900/45 backdrop-blur-2xl shadow-[0_10px_30px_rgba(0,0,0,0.35)]">
                <div className="absolute inset-0 pointer-events-none bg-gradient-to-b from-white/10 via-white/5 to-transparent" />
                <div className="max-w-7xl mx-auto w-full flex items-center justify-between px-6 sm:px-10 relative">
                    {/* Left: Logo */}
                    ...
                    <div className="flex-1 flex justify-end items-center gap-4 sm:gap-8">
                        <a
                            ...
                            className="px-5 py-2.5 bg-white hover:bg-zinc-50 active:bg-zinc-200 text-black font-mono font-bold text-xs uppercase tracking-widest shadow-[3px_3px_0px_0px_#f97316] hover:shadow-none active:shadow-none hover:translate-x-[1.5px] hover:translate-y-[1.5px] active:translate-x-[1.5px] active:translate-y-[1.5px] transition-all rounded-sm cursor-pointer border-none flex items-center gap-2"
                        >
                            Start Analysis
                        </a>
            ...
            <AnimatePresence>
                {isMobileMenuOpen && (
                    <motion.div
                        ...
                        className="fixed inset-0 z-[60] bg-zinc-950/85 backdrop-blur-2xl flex flex-col p-8 pt-24"
                    >
                        <button
                        ...
                        <div className="flex flex-col gap-8">
                            ...
                            <a
                                href="/app"
                                onClick={(e) => handleNavClick(e, 'scan')}
                                className="w-full py-5 bg-white hover:bg-zinc-50 active:bg-zinc-200 text-black font-mono font-bold text-lg uppercase tracking-widest shadow-[4px_4px_0px_0px_#f97316] hover:shadow-none active:shadow-none hover:translate-x-[2px] hover:translate-y-[2px] active:translate-x-[2px] active:translate-y-[2px] transition-all rounded-sm flex items-center justify-center gap-4"
                            >
                                Start Analysis
                            </a>
                        </div>
